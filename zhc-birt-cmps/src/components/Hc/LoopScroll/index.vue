...
export default {
  ...
  computed: {
    ...
    leftSwitch() {
      return {
        position: "absolute",
        margin: `${this.autoHeight() / 2}px 0 0 -${
    ...
    rightSwitch() {
      return {
        position: "absolute",
        margin: `${this.autoHeight() / 2}px 0 0 ${this.width +
  ...
  methods: {
    ...
    _initMove() {
      this.$nextTick(() => {
        ...
        // this.conf.height = this.$refs.wrap.offsetHeight;
        // this.conf.width = this.$refs.wrap.offsetWidth;
        ...
        this.$refs.realBox.style.width = slotListWidth - 1 + "px";
