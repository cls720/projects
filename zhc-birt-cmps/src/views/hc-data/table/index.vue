<template>
  <div style="padding:20px;">
    ...
    <table-mutiheader></table-mutiheader>
  </div>
</template>

<script>
import TableBasic from "./components/basic";
import TableMutiheader from "./components/mutiheader";

export default {
  components: { TableBasic, TableMutiheader },
  data() {
    return {    
      datas: [
        {
  ...
  mounted() {
    ...
    // this.treeData = convertToTreeData(cloneDatas, {
    //   id: "resId",
    //   parentId: "parentId",
    //   rootValue: "-1"
    // });
