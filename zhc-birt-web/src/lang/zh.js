export default {
  route: {
    ...
    serverMonitor: '服务器监控',
    devbusiness: '海创云经营情况分析',
    bootService: '微服务管理',
    myService: "我的服务",
    serviceRegister: "服务注册申请",
    serviceQuery: "服务查询",
    serviceStat: '服务统计',
    serviceEureka: '服务注册中心',
    serviceDetail: "服务详情",
    log: '日志管理',
    logLoginQuery: '登录日志查询',
    logErrorQuery: '异常日志查询',
    logGitCommitQuery: 'git提交日志查询',
    monitor: "监控",
    creation: "创作管理",
    creationQuery: "创作查询",
    market: "市场管理",
    ...
    marketDetail: '市场详情',
    customerDetail: "客户详情",
    marketSupplier: "供应商管理",
    supplierDetail: "供应商详情",
    marketOrder: "订单管理",
    user: '用户管理',
    userQuery: '用户查询',
    userAdd: '添加用户',
    userOnlineStat: '在线用户统计',
    userTypeStat: '用户统计',
    funclib: '函数库管理',
    funclibQuery: '函数查询',
    funclibAdd: '函数添加',
