export const columnSplitModel = {
  sheets: [{
    pageIndex: 0,
    style: "padding:10px;",
    controlId: "BirtGridSheet_column",
    layouts: [{
      tables: [{
        ...
        rows: {
          ...
          r4: {
            ...
            tds: {
              A4: {
                value: "序号",
                style: "text-align:center;background-color:rgb(84,166,180);color:rgb(255,255,255);border:1px solid rgb(255,255,255);border-left:1px solid rgb(204,204,204);font-family:Microsoft YaHei UI;"
              },
              B4: {
                value: "1",
