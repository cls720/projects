      ...
      <div>
        <el-form :model="form">
          <div class="detailitem">
            <el-form-item label="客户名称">{{form.FNAME}}</el-form-item>
          </div>
          <div class="detailitem">
    ...
    <el-card class="card">
      ...
      <div>
        <el-form :model="form">
          ...
          <div class="detailitem">
            <el-form-item label="开票电话">{{hideHhone(form.FKPDH)}}</el-form-item>
          </div>
          <div class="detailitem">
            <el-form-item label="开票地址">{{form.FKPDZ}}</el-form-item>
          </div>
          <div class="detailitem">
            <el-form-item label="收票人">{{form.FSPR}}</el-form-item>
          </div>
          <div class="detailitem">
            <el-form-item label="收票人联系电话">{{hideHhone(form.FSPRDH)}}</el-form-item>
          </div>
          <div>
            <el-form-item label="收票地址">{{form.FSPDZ}}</el-form-item>
          </div>
        </el-form>
      </div>
    </el-card>
