<template>
  ...
  >
      ...
      <div class="v-table-leftview" :style="{'width':leftViewWidth+'px'}">
                    ...
                    >
                      ...
                      >
                        <span class="table-title">
                          <!--isFold-->
                          <span v-if="col.isFold" @click.stop="headRowCloseOpen()">
                            <i :class="[&quot;v-table-filter-icon&quot;,&quot;v-icon-minus-squared-alt&quot;]" :level="getLevel(col)" fold="open" />
                          </span>
                          ...
                          <span v-else v-html="col.title" />
                          <span
                            v-if="enableSort(col.orderBy)"
                            class="v-table-sort-icon"
                            @click.stop="sortControl(col.fields[0])"
                          >
                            <i :class="[&quot;v-icon-up-dir&quot;,getCurrentSort(col.fields[0]) ===&quot;asc&quot; ? &quot;checked&quot;:&quot;&quot;]" />
                            <i :class="[&quot;v-icon-down-dir&quot;,getCurrentSort(col.fields[0]) ===&quot;desc&quot; ? &quot;checked&quot;:&quot;&quot;]" />
                          </span>
                        </span>
                        <!--filters-->
                        <v-dropdown
                          v-if="enableFilters(col)"
                          v-model="col.filters"
                        ...
                        >
                          <i :class="['v-table-filter-icon',vTableFiltersIcon(col.filters)]" />
                        </v-dropdown>
                      </div>
                    </td>
                  </tr>
                    ...
                    >
                      ...
                      >
                        ...
                        <span class="table-title">
                          ...
                          >
                            <i :class="[&quot;v-icon-up-dir&quot;,getCurrentSort(col.field) ===&quot;asc&quot; ? &quot;checked&quot;:&quot;&quot;]" />
                            <i :class="[&quot;v-icon-down-dir&quot;,getCurrentSort(col.field) ===&quot;desc&quot; ? &quot;checked&quot;:&quot;&quot;]" />
                          </span>
                        </span>
                        <!--filters-->
                        <v-dropdown
          ...
          <div :class="['v-table-body-inner',vTableBodyInner]">
            <v-checkbox-group v-model="checkboxGroupModel" @change="handleCheckGroupChange">
              <table class="v-table-btable" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                  <tr
                    v-for="(item,rowIndex) in tbodyTrs"
                    class="v-table-row"
                    :axis="item.axis"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <!--isFold-->
                        <span v-if="isFold(col)" @click.stop="bodyRowCloseOpen()">
                          <i :class="[&quot;v-table-filter-icon&quot;,&quot;v-icon-minus-squared-alt&quot;]" :level="col.level" :axis="col.axis" fold="open" />
                        </span>
                        <span v-if="typeof colField(col.field).componentName ==='string' && colField(col.field).componentName.length > 0">
                          <component
                            :is="colField(col.field).componentName"
                            :row-data="item"
                            :field="col.field ? col.field : ''"
                            :index="rowIndex"
                            @on-custom-comp="customCompFunc"
        ...
        >
          <table class="v-table-ftable" cellspacing="0" cellpadding="0" border="0">
            <tr v-for="(item,rowIndex) in frozenFooterCols" class="v-table-row">
              <td
    ...
    >
            ...
            <tbody>
              ...
              >
                ...
                >
                  ...
                  <div
                    v-else
                    :class="['v-table-body-cell',showVerticalBorder ? 'vertical-border':'',showHorizontalBorder?'horizontal-border':'', col.rowspan>1?'v-table-body-cell-warp':'']"
      ...
      >
        <table class="v-table-ftable" cellspacing="0" cellpadding="0" border="0">
          <tr v-for="(item,rowIndex) in noFrozenFooterCols" class="v-table-row">
            <td
              v-for="(col,colIndex) in item"
    ...
    <!--列拖动时的线条-->
    <div v-show="isDragging" class="v-table-drag-line" />
  </div>
</template>
...
<script>
import classesMixin from './mixin/classes-mixin.js'
import scrollControlMixin from './mixin/scroll-control-mixin.js'
import frozenColumnsMixin from './mixin/frozen-columns-mixin.js'
import tableResizeMixin from './mixin/table-resize-mixin.js'
import sortControlMixin from './mixin/sort-control-mixin.js'
import tableEmptyMixin from './mixin/table-empty-mixin.js'
import dragWidthMixin from './mixin/drag-width-mixin.js'
import cellEditMixin from './mixin/cell-edit-mixin.js'
import bodyCellMergeMixin from './mixin/body-cell-merge-mixin.js'
import titleCellMergeMixin from './mixin/title-cell-merge-mixin.js'
import checkboxSelectionMixin from './mixin/checkbox-selection-mixin.js'
import tableFooterMixin from './mixin/table-footer-mixin.js'
import scrollBarControlMixin from './mixin/scroll-bar-control-mixin.js'
import tableRowMouseEventsMixin from './mixin/table-row-mouse-events-mixin'
import tableFiltersMixin from './mixin/table-filters-mixin'
import tableFoldMixin from './mixin/table-fold-mixin'
import groupPolicyMixin from './mixin/group-policy-mixin'

import utils from '@/components/ZhcGpTable/utils/utils.js'
import deepClone from '@/components/ZhcGpTable/utils/deepClone.js'
