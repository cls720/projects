...
<script>
    import settings from '@/components/ZhcGpTable/settings/settings.js'
    import clickoutside from '@/components/ZhcGpTable/directives/clickoutside.js'

    import VCheckboxGroup from '../../v-checkbox-group/index'
    import VCheckbox from '../../v-checkbox/index'

    import layerAdjustment from '@/components/ZhcGpTable/mixin/layerAdjustment.js'
